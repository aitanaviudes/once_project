#!/usr/bin/env python
# roslaunch interbotix_xsarm_control xsarm_control.launch robot_model:=wx250s use_rviz:=false, true
...
class DemonstrationCollectorV2:  
    ...
    def start_recording(self):
        ...
        # disable torques before capturing scene
        self._reset_current_demo()
    ...
    def go_to_ready_position1(self):
